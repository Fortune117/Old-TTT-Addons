...
function PANEL:SetUp()
	...
	self.Slider.Knob.Paint = function(slf)
		draw.RoundedBox(0, 0, 0, slf:GetWide(), slf:GetTall(), Color(255,255,255,255))
	end
...
function PANEL:Paint()
	draw.SimpleText(self.Name, "RXCarFont_Treb_S20", 5,10, Color(200,200,200,255), TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
	
	--Slider Line
	draw.RoundedBox(0, 10, 24, self:GetWide()-20, 1, Color(150,150,150,255))
	
	draw.SimpleText(self.Min, "RXCarFont_Treb_S18", 10,32, Color(255,255,255,255), TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
	draw.SimpleText(self.Max, "RXCarFont_Treb_S18", self:GetWide()-10,32, Color(255,255,255,255), TEXT_ALIGN_RIGHT,TEXT_ALIGN_CENTER)
end
...
vgui.Register("RXCAR_Sliders",PANEL,"Panel")