...
function PANEL:Paint(w,h)
	local Active = self:GetPropertySheet():GetActiveTab() == self
	surface.SetDrawColor( Color( 88, 88, 88, (Active and 255 or 150 ) ) )
	surface.DrawRect( 0, 0, w, h )
end

derma.DefineControl( "DTab2", "A Tab for use on the PropertySheet", PANEL, "DButton" )
...
function PANEL:AddSheet( label, panel, material, NoStretchX, NoStretchY, Tooltip )
	...
	Sheet.Tab = vgui.Create( "DTab2", self )
...
derma.DefineControl( "DPropertySheet2", "", PANEL, "Panel" )
